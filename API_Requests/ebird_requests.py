...
if not all_data:
    ...
    # Ensure all expected columns are present, even if they are missing in the API response
    else:
        for col in cols:
        ...
        df_all = df_all[~df_all['obsDt'].str.startswith(date_str)]
        pandas_gbq.to_gbq(df_all, "raw_ebird_daily.raw_ebird", project_id="daily-ebird", if_exists="replace", credentials=credentials)